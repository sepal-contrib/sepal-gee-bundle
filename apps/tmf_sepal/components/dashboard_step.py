"""Dashboard step: button that opens a large modal with the TMF charts."""
...
from .dashboard import OverallPie, SummaryCard, YearTrend
...
def _csv_bytes(rows: list[dict]) -> bytes:
    ...
    for r in rows:
        ...
        buf.write(f"{r['code']},{label},{r['area_ha']}\n")
